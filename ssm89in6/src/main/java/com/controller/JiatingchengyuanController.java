...
public class JiatingchengyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiatingchengyuanEntity user = jiatingchengyuanService.selectOne(new EntityWrapper<JiatingchengyuanEntity>().eq("zhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"jiatingchengyuan",  "家庭成员" );
    ...
    public R register(@RequestBody JiatingchengyuanEntity jiatingchengyuan){
    	//ValidatorUtils.validateEntity(jiatingchengyuan);
    	JiatingchengyuanEntity user = jiatingchengyuanService.selectOne(new EntityWrapper<JiatingchengyuanEntity>().eq("zhanghao", jiatingchengyuan.getZhanghao()));
		if(user!=null) {
			return R.error("注册用户已存在");
		}
		Long uId = new Date().getTime();
		jiatingchengyuan.setId(uId);
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        JiatingchengyuanEntity user = jiatingchengyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        jiatingchengyuanService.updateById(user);
    ...
    public R save(@RequestBody JiatingchengyuanEntity jiatingchengyuan, HttpServletRequest request){
		...
		jiatingchengyuan.setId(new Date().getTime());
        jiatingchengyuanService.insert(jiatingchengyuan);
        return R.ok();
    }
