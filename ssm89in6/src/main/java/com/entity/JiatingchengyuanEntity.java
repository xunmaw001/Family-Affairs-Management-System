...
public class JiatingchengyuanEntity<T> implements Serializable {
	 ...
	 * 设置：家庭角色
	 */
	public void setJiatingjiaose(String jiatingjiaose) {
		this.jiatingjiaose = jiatingjiaose;
	}
	/**
	 * 获取：家庭角色
	 */
	public String getJiatingjiaose() {
		return jiatingjiaose;
	}
	/**
	 * 设置：性别
	 */
