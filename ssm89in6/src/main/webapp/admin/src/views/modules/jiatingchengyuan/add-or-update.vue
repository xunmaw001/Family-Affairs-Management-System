<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家庭角色" prop="jiatingjiaose">
          <el-input v-model="ruleForm.jiatingjiaose" 
              placeholder="家庭角色" clearable  :readonly="ro.jiatingjiaose"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家庭角色" prop="jiatingjiaose">
              <el-input v-model="ruleForm.jiatingjiaose" 
                placeholder="家庭角色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
