  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">家庭事务管理小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			<!-- <div v-if="tableName=='jiatingchengyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='jiatingchengyuan'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jiatingchengyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiatingchengyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='jiatingchengyuan'" class="input-group">
			   <div class="label">家庭角色</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiatingjiaose" class="input" type="text" placeholder="家庭角色">
			   </div>
			 </div> -->
			<el-form-item label="家庭角色" class="input" v-if="tableName=='jiatingchengyuan'">
			  <el-input v-model="ruleForm.jiatingjiaose" autocomplete="off" placeholder="家庭角色"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiatingchengyuan'" class="input-group">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jiatingchengyuan'">
