<template>
	<view class="content">
		<form class="app-update-pv">
				...
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(21, 20, 20, 1)","textAlign":"left"}' class="title">事务类型</view>
				<picker @change="shiwuleixingChange" :value="shiwuleixingIndex" :range="shiwuleixingOptions">
					<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(20, 19, 19, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.shiwuleixing?ruleForm.shiwuleixing:"请选择事务类型"}}</view>
				</picker>
			</view>
																					<view :style='{"boxShadow":"","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"#ccc","margin":"","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				...
				<input :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(40, 38, 38, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.xingming" v-model="ruleForm.xingming" placeholder="姓名"></input>
												...
												<view :style='{"boxShadow":"","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"rgba(252, 252, 252, 1)","margin":"","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(21, 20, 20, 1)","textAlign":"left"}' class="title">事务进度</view>
				<picker @change="shiwujinduChange" :value="shiwujinduIndex" :range="shiwujinduOptions">
					<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(20, 19, 19, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.shiwujindu?ruleForm.shiwujindu:"请选择事务进度"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"","backgroundColor":"rgba(255, 255, 255, 0.56)","borderColor":"#ccc","margin":"","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
			...
			<!-- 否 -->
				...
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(28, 27, 27, 1)","textAlign":"left"}' class="title">事务详情</view>
				<textarea :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 22, 22, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.shiwuxiangqing" placeholder="事务详情"></textarea>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			this.user = res.data;
						...
						// ss读取
																								...
																								// 下拉框
			res = await this.$api.option(`shiwuleixing`,`shiwuleixing`,{});
			this.shiwuleixingOptions = res.data;
																								// 下2
			res = await this.$api.option(`jiatingchengyuan`,`zhanghao`,{});
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`jiatingshiwu`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='shiwujindu'){
					this.ruleForm.shiwujindu = obj[o];
					this.ro.shiwujindu = true;
					continue;
					}
		...
		methods: {
			...
			async zhanghaoChange (e) {
				...
				let res = await this.$api.follow(`jiatingchengyuan`, `zhanghao`,{
			...
			wanchengshijianConfirm(val) {
				...
				this.$forceUpdate();
																					...
																					// 下拉变化
			shiwuleixingChange(e) {
				this.shiwuleixingIndex = e.target.value
				this.ruleForm.shiwuleixing = this.shiwuleixingOptions[this.shiwuleixingIndex]
			},
																																				// 下拉变化
			shiwujinduChange(e) {
				this.shiwujinduIndex = e.target.value
				this.ruleForm.shiwujindu = this.shiwujinduOptions[this.shiwujinduIndex]
			},
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																if(this.ruleForm.id){
					await this.$api.update(`jiatingshiwu`, this.ruleForm);
				}else{
					await this.$api.add(`jiatingshiwu`, this.ruleForm);
				}
