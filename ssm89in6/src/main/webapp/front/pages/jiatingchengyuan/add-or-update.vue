	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`jiatingchengyuan`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='jiatingjiaose'){
					this.ruleForm.jiatingjiaose = obj[o];
					this.ro.jiatingjiaose = true;
					continue;
					}
					if(o=='xingbie'){
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																												...
																																																												if(this.ruleForm.id){
					await this.$api.update(`jiatingchengyuan`, this.ruleForm);
				}else{
					await this.$api.add(`jiatingchengyuan`, this.ruleForm);
				}
